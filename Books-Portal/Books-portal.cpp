...
Book::Book(int i, const string &t, const string &a, int isbn) : id_(i), title_(t), author_(a), ISBN_(isbn), status_("Available"), copies_(1) {}
Book::~Book() {}
...
{
    return to_string(id_) + "," + title_ + "," + author_ + "," + to_string(ISBN_) + "," + status_ + "," + to_string(copies_);
}
